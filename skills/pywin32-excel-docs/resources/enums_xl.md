# Excel Enumerations (Xl* constants)

> Parameter types shown as `XlFoo` refer to these enum values.
> Pass the integer value or use `win32com.client.constants.<name>` at runtime.
